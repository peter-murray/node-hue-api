...
The following is the documentation for the old v2 API. This is provided as a reference for anyone still using the
backwards compatibility [shim](../README.md#2x-backwards-compatibility-shim).
