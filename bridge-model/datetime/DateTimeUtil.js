...
module.exports = {
  ...
  regex: {
    ...
    //TODO expand once classes are implmented
  },


  timerRandomRegex: new RegExp(`PT${patterns.time}A${patterns.time}`),
  ...
  recurring: new RegExp(`'${patterns.weekday}/T${patterns.time}`),
