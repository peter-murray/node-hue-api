...
describe('Hue API #lightState', () => {
  ...
  describe('single states', () => {
    ...
    describe('state: sat', () => {
      ...
      function testFailure(functionName, value) {
        try {
          state[functionName](value);
          expect.fail('Should have thrown an error');
        } catch (err) {
          expect(err).to.exist;
          expect(err.message).to.contain(RANGE_ERROR_STRING);
        }
      }
    ...
    describe('state: transitiontime', () => {
      ...
      describe('#transitionInMillis()', () => {
        ...
        function test(value, expected) {
          state.transitionTimeInMillis(value);
          validateTransitionTimeState(expected);
        }
    ...
    describe('state: bri_inc', () => {
      ...
      function testBrightnessIncrement(functionName, value) {
        state[functionName](value);
        validateBrightnessIncrement(value);
      }
      ...
      describe('#bri_inc()', () => {
        ...
        function test(value) {
          testBrightnessIncrement('bri_inc', value, value);
        }
    ...
    describe('state: sat_inc', () => {
      ...
      function testSaturationIncrement(functionName, value) {
        state[functionName](value);
        validateSaturationIncrement(value);
      }
      ...
      describe('#sat_inc()', () => {
        ...
        function test(value) {
          testSaturationIncrement('sat_inc', value);
        }
      ...
      describe('#incrementSaturation()', () => {
        ...
        function test(value) {
          testSaturationIncrement('incrementSaturation', value);
        }
    ...
    describe('state: hue_inc', () => {
      ...
      function testHueIncrement(functionName, value) {
        state[functionName](value);
        validateHueIncrement(value);
      }
      ...
      describe('#sat_inc()', () => {
        ...
        function test(value) {
          testHueIncrement('hue_inc', value);
        }
      ...
      describe('#incrementHue()', () => {
        ...
        function test(value) {
          testHueIncrement('incrementHue', value);
        }
    ...
    describe('state: ct_inc', () => {
      ...
      function testCtIncrement(functionName, value) {
        state[functionName](value);
        validateCtIncrement(value);
      }
      ...
      describe('#incrementCt()', () => {
        ...
        function test(value) {
          testCtIncrement('incrementCt', value);
        }
      ...
      describe('#incrementColorTemp()', () => {
        ...
        function test(value) {
          testCtIncrement('incrementColorTemp', value);
        }
      ...
      describe('#incrementColourTemp()', () => {
        ...
        function test(value) {
          testCtIncrement('incrementColourTemp', value);
        }

        function testFailure(value) {
          testFailureCtIncrement('incrementColourTemp', value, RANGE_ERROR_STRING);
        }
