...
const expect = require('chai').expect
  , CLIPOpenClose = require('../../devices/sensors/CLIPOpenClose')
  , CLIPSwitch = require('../../devices/sensors/CLIPSwitch')
...
describe('SensorCondition', () => {
  ...
  describe('creating valid conditions', () => {
    ...
    describe('CLIPOpenClose Sensor', () => {
      ...
      const sensor = new CLIPOpenClose({state: {open: false}}, 1);
    ...
    describe('CLIPSwitch Sensor', () => {
      ...
      const sensor = new CLIPSwitch({state: {buttonevent: 0}});
