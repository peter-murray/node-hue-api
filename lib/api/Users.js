...
module.exports = class Users extends ApiDefinition {
  ...
  createUser(appName, deviceName, noClientKey) {
    //TODO perform validation on the bridge config to see if it supports the generateKey parameters once we have a known version number
    return this.execute(configurationApi.createUser, {appName: appName, deviceName: deviceName, generateKey: !noClientKey});
  }
