...
module.exports = class LocalBootstrap {
   ...
   *
   * @param username The username to use when connecting, can be null, but will severely limit the endpoints that you can call/access
   * @param clientkey The clientkey for the user, used by the entertainment API, can be null
   * @param timeout The timeout for requests sent to the Hue Bridge. If not set will default to 20 seconds.
